...
const desirabilityQuestions = ['projectSubject', 'projectImpact']
const desirabilityRoboticsQuestions = ['projectSubject', 'dataAnalytics', 'energySource', 'agriculturalSector', 'technologyUse']
