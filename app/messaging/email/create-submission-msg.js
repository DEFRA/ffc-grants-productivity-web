...
function getEmailDetails (submission, desirabilityScore, rpaEmail, isAgentEmail = false) {
  ...
  return {
    ...
    details: {
      ...
      dataAnalyticsScore: submission.dataAnalytics && submission.projectSubject !== PROJECT_SUBJECT_SLURRY ? getQuestionScoreBand(desirabilityScore.desirability.questions, 'data-analytics') : ' ',
      ...
      agriculturalSectorScore: submission.projectSubject !== PROJECT_SUBJECT_SLURRY ? getQuestionScoreBand(desirabilityScore.desirability.questions, 'agricultural-sector') : ' ',
