...
describe('getUrl()', () => {
  ...
  it('should return url if urlObject is empty', () => {
    expect(getUrl(urlObject, 'mock-url', {}, secBtn, '')).toEqual(`${urlPrefix}/score`)
  ...
  it('should return secBtnPath if secBtn is "Back to score"', () => {
    ...
    expect(getUrl(urlObject, 'mock-url', {}, 'Back to score', '')).toEqual(`${urlPrefix}/score`)
  })
  ...
  //     dependentQuestionYarKey: 'dependentAnswerKeysArray'
  //   }
  //   expect(getUrl(urlObject, 'mock-url', {}, 'i_hate_js', 'grid-reference')).toEqual(`${urlPrefix}/planning-permission-summary`)
  // })
  it('should default to /check-details if secBtn is not "Back to score" and current url is not a building or planning page', () => {
    ...
    expect(getUrl(urlObject, 'mock-url', {}, 'i-wish-i-was-writing-python', 'or-even-java')).toEqual(`${urlPrefix}/check-details`)
  })
})
